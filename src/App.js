    ...
    <div className="container">
      <div className = 'content'>
       ...
       <div className ='buttonarea'>
          <button className ='buttonc'value ='C' type ='button' onClick ={() => clear() }>C</button>
         ...
         <div className ='buttonarea'>
          ...
          <div className ='buttonarea'>
            <button className ='buttonc'value ='0' type ='button' onClick ={event => addNumber(event.target.value)}>0</button>
